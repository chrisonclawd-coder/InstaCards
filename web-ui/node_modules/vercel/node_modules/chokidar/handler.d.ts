...
export declare const IDENTITY_FN: (val: any) => any;
...
export declare class NodeFsHandler {
    ...
    _handleRead(directory: string, initialAdd: boolean, wh: WatchHelper, target: Path, dir: Path, depth: number, throttler: any): Promise<unknown> | undefined;
    /**
     ...
     */
    _handleDir(dir: string, stats: Stats, initialAdd: boolean, dept