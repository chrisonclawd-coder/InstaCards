...
const projects: Project[] = [
  {
    id: '1',
    name: 'InstaCards Extension',
    description: 'AI-powered flashcard generator Chrome extension',
    status: 'active',
    icon: '📖',
    tasks: [
      { id: '1-1', name: 'Project Setup & Structure', description: 'Set up folder structure, dependencies, and configuration files', status: 'done', priority: 'high', progress: 100, projectId: '1' },
      { id: '1-2', name: 'Build System Fix (Windows)', description: 'Fix build script to work on Windows (cp -> node fs)', status: 'done', priority: 'high', progress: 100, projectId: '1' },
      { id: '1-3', name: 'Manifest.json Fix', description: 'Fix manifest to reference .js files instead of .ts', status: 'done', priority: 'high', progress: 100, projectId: '1' },
      { id: '1-4', name: 'HTML Files Copy Fix', description: 'Add HTML files to dist in build script', status: 'done', priority: 'high', progress: 100, projectId: '1' },
      { id: '1-5', name: 'Implement OpenRouter API Integration', description: 'Actually call OpenRouter GPT API for flashcard generation instead of placeholders', status: 'in-progress', priority: 'high', progress: 30, projectId: '1' },
      { id: '1-6', name: 'Content Extraction', description: 'Extract article content and send to AI for flashcard generation', status: 'todo', priority: 'high', progress: 0, projectId: '1' },
      { id: '1-7', name: 'Review Queue UI', description: 'Implement spaced repetition review UI in popup', status: 'todo', priority: 'medium', progress: 0, projectId: '1' },
      { id: '1-8', name: 'Test Extension', description: 'Test on real websites, verify API key handling', status: 'todo', priority: 'high', progress: 0, projectId: '1' },
      { id: '1-9', name: 'Submit to Chrome Web Store', description: 'Prepare for submission and launch', status: 'todo', priority: 'high', progress: 0, projectId: '1' },
    ],
    totalTasks: 9,
    completedTasks: 4,
